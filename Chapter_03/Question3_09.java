...
public class Question3_09 {
    public static void main(String[] args) {
        ...
        // if (checkSum == 10){
        //     System.out.printf("The ISBN-10 number is %s", digitsStr + "X");
        // } else {
        //     String newSum = Integer.toString(checkSum);
        ...
        if (lastDigit == 10) {
            ...
            lastChar = (char) (lastDigit + '0');
        }

        // Display the 10-digit ISBN
        String isbn = String.format("%09d%c", firstNineDigits, lastChar);
